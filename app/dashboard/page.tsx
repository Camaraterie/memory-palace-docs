...
export default function DashboardPage() {
  return (
    <main style={{ minHeight: '100vh', padding: '2rem', maxWidth: '48rem', margin: '0 auto' }}>
      ...
      <h1 style={{ fontSize: '1.875rem', fontWeight: 'bold', color: 'var(--gold)', marginBottom: '2rem' }}>Palace Dashboard</h1>
      <p style={{ color: 'var(--text-secondary)' }}>Placeholder for the auth-gated dashboard.</p>
    </main>
  );
}
