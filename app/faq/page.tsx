...
export default async function FAQPage() {
  const res = await fetch('https://m.cuer.ai/api/faq', { next: { revalidate: 3600 } });
  ...
  return (
    <main style={{ minHeight: '100vh', padding: '2rem', maxWidth: '48rem', margin: '0 auto' }}>
      ...
      <h1 style={{ fontSize: '1.875rem', fontWeight: 'bold', color: 'var(--gold)', marginBottom: '2rem' }}>Frequently Asked Questions</h1>
